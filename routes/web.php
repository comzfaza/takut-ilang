...
Route::post('/hapus-pengaduan/{id}', [wildanController::class,'hapus']);

Route::post('/detail-pengaduan/{id}', [wildanController::class,'detail']);

Route::get('/home/detail_ngadu/{id}', [wildanController::class,'detail_ngadu']);
